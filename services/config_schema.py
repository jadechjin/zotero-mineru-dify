...
CONFIG_SCHEMA = {
    ...
    "image_summary": {
        ...
        "provider": {"type": "select", "default": "openai", "options": ["openai", "newapi"], "label": "视觉 API 提供方", "sensitive": False},
        ...
        "use_system_proxy": {"type": "bool", "default": True, "label": "遵循系统代理设置", "sensitive": False},
        "extra_body_json": {"type": "str", "default": "", "label": "扩展请求参数(JSON)", "sensitive": False},
        "concurrency": {"type": "int", "default": 4, "min": 1, "max": 32, "label": "图片解析并发数", "sensitive": False},
...
ENV_KEY_MAP = {
    ...
    "IMAGE_SUMMARY_PROVIDER": ("image_summary", "provider"),
    ...
    "IMAGE_SUMMARY_USE_SYSTEM_PROXY": ("image_summary", "use_system_proxy"),
    "IMAGE_SUMMARY_EXTRA_BODY_JSON": ("image_summary", "extra_body_json"),
    "IMAGE_SUMMARY_CONCURRENCY": ("image_summary", "concurrency"),
